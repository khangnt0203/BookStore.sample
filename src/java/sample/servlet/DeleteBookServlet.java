    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bookID != null) {
                ...
                boolean checkDelete = bookDAO.deleteBook(bookID);

                if (checkDelete) {
                    request.setAttribute(GobalStore.DELETE_BOOK_SUCCESS, "delete sucess");
                } else {
                    request.setAttribute(GobalStore.DELETE_BOOK_FAILED, "delete failed");
                }
            }
