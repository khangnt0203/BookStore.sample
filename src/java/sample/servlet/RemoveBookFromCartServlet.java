...
public class RemoveBookFromCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String txtConfirmRemove = request.getParameter("txtConfirmRemove");
            String txtBookID = request.getParameter("txtBookID");
            if (txtConfirmRemove != null && txtBookID != null) {
                if (txtConfirmRemove.equals("true")) {
